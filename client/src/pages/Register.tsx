      ...
      >
        <div className="p-8">
          <motion.div className="text-center mb-8" variants={itemVariants}>
            ...
            <p className="text-[#65676B]">Create your account to get started</p>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants}>
              <label htmlFor="username" className="block text-sm font-medium text-[#65676B] mb-1">
                Username
              </label>
              <motion.input
                type="text"
            ...
            <motion.div className="flex items-center" variants={itemVariants}>
              <input
                ...
                required
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-[#65676B]">
                I agree to the <a href="#" className="text-[#00B2FF] hover:underline">Terms</a> and <a href="#" className="text-[#00B2FF] hover:underline">Privacy Policy</a>
              </label>
            </motion.div>
          ...
          <motion.div className="mt-6" variants={itemVariants}>
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-[#65676B]">Or sign up with</span>
              </div>
            </div>
